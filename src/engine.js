  ...
  var Engine = {
    ...
    _buildImageCloner: function (mode, selectionIds) {
      ...
      if (!cloneShape) {
        ...
        // Generator names MUST carry the "Shape" suffix — bare "ellipse"/"rectangle"
        // silently fall back to a polygon (pentagon). Verified live.
        api.setGenerator(cloneShape, "generator", mode === "density" ? "ellipseShape" : "rectangleShape");
      }
